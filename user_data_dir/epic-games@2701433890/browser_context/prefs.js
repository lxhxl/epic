...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1725229905);
user_pref("app.update.lastUpdateTime.background-update-timer", 1725229905);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1725229905);
user_pref("app.update.lastUpdateTime.region-update-timer", 1725143473);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1725229905);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1723852599);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1725229905);
...
user_pref("browser.startup.lastColdStartupCheck", 1725229875);
