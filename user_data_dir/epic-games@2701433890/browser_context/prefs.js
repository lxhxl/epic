...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1725748362);
user_pref("app.update.lastUpdateTime.background-update-timer", 1725748362);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1725834656);
user_pref("app.update.lastUpdateTime.region-update-timer", 1725748362);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1725748362);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1723852599);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1725748362);
...
user_pref("browser.contextual-services.contextId", "{56b703ab-def9-4a1b-a79c-860fd81da9ad}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{5e19ec87-d94b-4093-b62e-7a1835b0a86c}");
...
user_pref("browser.startup.lastColdStartupCheck", 1725834626);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECAaWeBSMQwQGBAh9d9ofoe2a2g==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"911b2434-93a5-4027-9bc1-7b4619ce052f\",\"pictureinpicture@mozilla.org\":\"122a8904-6e3f-4526-a2df-e80fadf8b4d0\",\"screenshots@mozilla.org\":\"899a12b5-6631-453b-9c69-c4a5ea28748b\",\"webcompat-reporter@mozilla.org\":\"81e0d9f9-9a84-4102-9ab7-c7801e4b6557\",\"webcompat@mozilla.org\":\"63256ec8-8bd9-404d-9091-f24b4dc3bb26\",\"default-theme@mozilla.org\":\"5be3b1b1-dabd-41bf-97f6-d258e2cba29b\",\"addons-search-detection@mozilla.com\":\"04401f5f-5f92-4da6-b3b5-ef67270d415c\"}");
...
user_pref("media.gmp-manager.lastCheck", 1725748357);
user_pref("media.gmp-manager.lastEmptyCheck", 1725748357);
...
user_pref("security.sandbox.content.tempDirSuffix", "7f52dea8-d7ab-4834-98ec-e7817ef7bc2d");
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECA/altN3hlIdBAhFJoFR+SKGIA==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1725834626);
